...
[
  ...
  { title: "就寝", start_time: '23:30', end_time: '24:00' }
].each do |schedule|
  DefaultSchedule.create!(
    chronotype_id: 4,
    title: schedule[:title],
    activity_type: "オオカミ型のスケジュール",
    start_time: to_jst_time(schedule[:start_time]),
    end_time: to_jst_time(schedule[:end_time]),
    day_of_week: 0
  )
end
...
[
  ...
  { title: "睡眠", start_time: '00:30', end_time: '06:00' },
  ...
  { title: "就寝・睡眠", start_time: '23:30', end_time: '24:00' }
].each do |schedule|
  DefaultSchedule.create!(
    chronotype_id: 1,
    title: schedule[:title],
...
[
  ...
  { title: "睡眠", start_time: '22:30', end_time: '24:00' }
].each do |schedule|
  DefaultSchedule.create!(
    chronotype_id: 2,
    title: schedule[:title],
...
[
  ...
  { title: "睡眠", start_time: '23:00', end_time: '24:00' }
].each do |schedule|
  DefaultSchedule.create!(
    chronotype_id: 3,
    title: schedule[:title],
