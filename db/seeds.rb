...
def to_utc(time_str)
  ...
  utc_hours = (hours - 9) % 24
  "#{utc_hours.to_s.rjust(2, '0')}:#{minutes.to_s.rjust(2, '0')}"
end

# オオカミ型（chronotype_id: 4）のデフォルトスケジュール
[
  { title: "睡眠", start_time: '15:30', end_time: '22:00' },
...
[
  { title: "睡眠", start_time: '15:30', end_time: '21:00' },
...
[
  ...
  { title: "睡眠", start_time: '13:30', end_time: '15:00' }
].each do |schedule|
  DefaultSchedule.create!(
    chronotype_id: 2,
    title: schedule[:title],
...
[
  ...
  { title: "睡眠", start_time: '14:00', end_time: '15:00' }
].each do |schedule|
  DefaultSchedule.create!(
    chronotype_id: 3,
    title: schedule[:title],
